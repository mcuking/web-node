...
**质量门禁**：`tsc --noEmit` 干净 · `vitest run` **337/337 通过（38 files）** · `vite build` 绿（worker **1028KB** / index ~10.8KB / css ~4.1KB，worker gzip ~237KB）
