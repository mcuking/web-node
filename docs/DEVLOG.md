...
**质量门禁**：`tsc --noEmit` 干净 · `vitest run` **374/374 通过（41 files）** · `vite build` 绿（worker **1201KB** / index ~10.8KB / css ~4.1KB，worker gzip ~272KB）
