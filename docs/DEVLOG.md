...
**质量门禁**：`tsc --noEmit` 干净 · `vitest run` **341/341 通过（39 files）** · `vite build` 绿（worker **1130KB** / index ~10.8KB / css ~4.1KB，worker gzip ~257KB）
