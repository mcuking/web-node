...
**质量门禁**：`tsc --noEmit` 干净 · `vitest run` **479/479 通过（48 files）** · `vite build` 绿（worker **1625.03KB** / index ~10.87KB / css ~4.06KB）
