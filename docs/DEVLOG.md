...
**质量门禁**：`tsc --noEmit` 干净 · `vitest run` **485/485 通过（49 files）** · `vite build` 绿（worker **1626.66KB** / index ~10.87KB / css ~4.06KB）
