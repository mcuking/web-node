...
**质量门禁**：`tsc --noEmit` 干净 · `vitest run` **363/363 通过（40 files）** · `vite build` 绿（worker **1145KB** / index ~10.8KB / css ~4.1KB，worker gzip ~263KB）
